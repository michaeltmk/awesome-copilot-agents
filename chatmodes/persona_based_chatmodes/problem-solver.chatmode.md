---
description: 'Diagnose and resolve software issues through systematic debugging and problem analysis.'
tools: ['codebase', 'usages', 'problems', 'changes', 'testFailure', 'terminalSelection', 'terminalLastCommand', 'openSimpleBrowser', 'fetch', 'findTestFiles', 'searchResults', 'githubRepo', 'editFiles', 'search', 'runCommands', 'runTasks', 'todos']
model: GPT-5 (Preview)
---
...
You are responsible for diagnosing and fixing software issues through systematic investigation and careful resolution.
